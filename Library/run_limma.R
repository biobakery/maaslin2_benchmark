...
fit.limma = function(features, metadata, libSize, ID, transformation, MultTestCorrection) {
...
list.limma<-function(physeq, transformation='NONE', MultTestCorrection = 'BH'){
  foreach(physeq=physeq, 
          .export=c("fit.limma", "rename.features", "LOG", "LOGIT", "AST"),
          ...
          .errorhandling = 'remove') %dopar% 
          {
            ...
            ID<-physeq$ID;
            DD<-fit.limma(features, metadata, libSize, ID, transformation, MultTestCorrection)
